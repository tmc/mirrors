...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GETCOMPLETIONSREQUEST_LOGITBIASENTRY']._loaded_options = None
  _globals['_GETCOMPLETIONSREQUEST_LOGITBIASENTRY']._serialized_options = b'8\001'
  _globals['_MESSAGE'].fields_by_name['content_legacy']._loaded_options = None
  _globals['_MESSAGE'].fields_by_name['content_legacy']._serialized_options = b'\030\001'
